\name{c212.interim.1a.hier2}
\alias{c212.interim.1a.hier2}
%- Also NEED an '\alias' for EACH other topic documented here.
\title{A Two-Level Hierarchical Body-system based Model for interim analysis without Point-Mass.}
\description{
...
\item{level}{
The level of longitudinal dependancy between the intervals. 0 - independent intervals, 1 - common interva body-system means.
dependancy.
}
  \item{hyper_params}{
