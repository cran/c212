...
Id <- "$Id: c212.interim.BB.hier3.lev2.convergence.R,v 1.10 2019/05/05 13:18:12 clb13102 Exp clb13102 $"

c212.interim.BB.dep.lev2.convergence.diag <- function(raw, debug_diagnostic = FALSE)
{
	c_base = c212.interim.1a.dep.lev2.convergence.diag(raw, debug_diagnostic)
	...
	#theta_acc <- array(NA, dim = c(nchains, raw$nIntervals, raw$maxBs, raw$maxAEs))
...
c212.interim.BB.dep.lev2.print.convergence.summary <- function(conv) {
	if (is.null(conv)) {
